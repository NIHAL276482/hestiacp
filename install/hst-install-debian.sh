...
if [ -z "$withdebs" ] || [ ! -d "$withdebs" ]; then
	release_branch_ver=$(curl -s https://raw.githubusercontent.com/NIHAL276482/hestiacp/release/src/deb/hestia/control | grep "Version:" | awk '{print $2}')
	if [ "$HESTIA_INSTALL_VER" != "$release_branch_ver" ]; then
		...
		echo ""
		echo -e "\e[33mhttps://raw.githubusercontent.com/NIHAL276482/hestiacp/release/install/hst-install.sh\e[0m"
		echo ""
...
case $architecture in
	...
	*)
		...
		echo ""
		echo -e "\e[33mhttps://github.com/NIHAL276482/hestiacp/blob/main/README.md\e[0m"
		echo ""
		check_result 1 "Installation aborted"
		;;
esac
...
GitHub:         https://www.github.com/NIHAL276482/hestiacp
