...
Hestia is an open-source project, and we welcome contributions from the community. Please read the [contributing guidelines](https://github.com/NIHAL276482/hestiacp/blob/main/CONTRIBUTING.md) for additional information.
...
::: warning
Development builds are unstable. If you encounter a bug, please [report it via GitHub](https://github.com/NIHAL276482/hestiacp/issues/new/choose) or [submit a Pull Request](https://github.com/NIHAL276482/hestiacp/pulls).
:::
...
1. [Fork Hestia](https://github.com/NIHAL276482/hestiacp/fork) and clone the repository to your local machine
...
Please refer to the [contributing guidelines](https://github.com/NIHAL276482/hestiacp/blob/main/CONTRIBUTING.md#development-guidelines) for more details on submitting code changes for review.
...
git clone --recurse-submodules https://github.com/NIHAL276482/hestiacp
