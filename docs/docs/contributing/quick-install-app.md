...
- Run commands. For example, use `drush` to install [Drupal](https://github.com/NIHAL276482/hestiacp/blob/88598deb49cec6a39be4682beb8e9b8720d59c7b/web/src/app/WebApp/Installers/Drupal/DrupalSetup.php#L56-L65).
...
Once you are done, you can [submit a Pull Request](https://github.com/NIHAL276482/hestiacp/pulls) and we will review the code. If it meets our standards, we will include in the next release.
