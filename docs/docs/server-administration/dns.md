...
::: info
It doesn't work if you try to sync via local network! See [Issue](https://github.com/NIHAL276482/hestiacp/issues/4295) Make sure to use the public ip addresses
:::
